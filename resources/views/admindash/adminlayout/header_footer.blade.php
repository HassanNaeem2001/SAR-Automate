...
<!-- Mirrored from demo.dashboardpack.com/marketing-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2024 08:02:48 GMT -->
<head>

<meta charset="utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
<title>Marketing</title>
<link rel="icon" href="{{asset('adminassets/img/logo.png')}}" type="image/png">

<link rel="stylesheet" href="{{asset('adminassets/css/bootstrap1.min.css')}}" />
...
<a href="index-2.html"><img src="{{asset('adminassets/img/logo.png')}}" alt></a>
...
<li><a href="{{route('ViewStudents')}}">View Students</a></li>
...
<ul>
<li><a class="active" href="index-2.html">Generate SAR</a></li>
...
<li>
<a class="CHATBOX_open nav-link-notify" href="#"> <img src="{{asset('adminassets/img/icon/msg.svg')}}" alt> </a>
</li>
</div>
...
<p>2024 © - Designed by <a href="hassannaeem.netlify.app"> <i class="ti-heart"></i> </a><a href="#"> Hassan Bin Naeem</a></p>
</div>
</div>
</div>
</div>
...
<script src="{{asset('adminassets/js/jquery1-3.4.1.min.js')}}"></script>

<script src="{{asset('adminassets/js/popper1.min.js')}}"></script>

<script src="{{asset('adminassets/js/bootstrap1.min.js')}}"></script>
...
<script src="{{asset('adminassets/vendors/datatable/js/dataTables.responsive.min.jsl;')}}"></script>
...
<script src="{{asset('adminassets/vendors/chart_am/core.js')}}"></script>
<script src="{{asset('adminassets/vendors/chart_am/charts.js')}}"></script>
<script src="{{asset('adminassets/vendors/chart_am/animated.js')}}"></script>
<script src="{{asset('adminassets/vendors/chart_am/kelly.js')}}"></script>
<script src="{{asset('adminassets/vendors/chart_am/chart-custom.js')}}"></script>

<script src="{{asset('adminassets/js/custom.js')}}"></script>
</body>

<!-- Mirrored from demo.dashboardpack.com/marketing-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2024 08:03:30 GMT -->
</html>
